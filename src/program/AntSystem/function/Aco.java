...
import program.AntSystem.graph.Vertex;
...
public class Aco {
    ...
    public static final double B=3d;//参数β
    public static final double C=0.2d;//信息素更新的参数
    public static final double q0=0.5d;
    public static Graph graph;//图数据对象 使用邻接表存储
    public static SubGraphs subGraph;
    public static double[][] pheromone;//信息素矩阵
    public static double phe=0.6d;
    public static int[][] flow;//流量矩阵
    public static final double VELOCITY=0.5d;
    public static final double w=0.6d;
    public static Graph allGraph;
